...
def getall():
    if request.method == 'POST':
        ...
        query = text("INSERT INTO calorias_quemadas (id_usuario, sexo, edad, altura, peso, actividad, calorias_quemadas) VALUES (:id_usuario, :sexo, :edad, :altura, :peso, :actividad, :calorias_quemadas)")
        db.session.execute(query, {"id_usuario": session['user_id'], "sexo": sexo, "edad": fecha_nacimiento, "altura": altura, "peso": peso, "actividad": actividad, "calorias_quemadas": calorias_quemadas})
        db.session.commit()
